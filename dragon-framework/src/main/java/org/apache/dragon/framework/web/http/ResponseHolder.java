...
public abstract class ResponseHolder  {
	 ...
	 * thread holder
	 */
	private static final Holder<HttpServletResponse> holder = new ThreadHolder<HttpServletResponse>();
	 ...
	 * @param req the HttpServletResponse to expose,
	 * or {@code null} to reset the thread-bound context
	 * @return
	 */
	public static void set(HttpServletResponse req) {
		holder.set(req);
	}
