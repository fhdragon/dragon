...
/**
 * PriorityQueueTest: test for PriorityQueue
 * 
 * @author Wenlong Meng(wenlong.meng@gmail.com)
 * @version 1.0 at Apr 4, 2013
 * @since 1.0
 */
public class PriorityQueueTest {
	 ...
	 * logger
	 */
	private static Logger logger = Logger.getLogger(PriorityQueueTest.class);
	...
	public static void main(String[] args){
		int[] is = {1, 3, 5, 7, 7, 9};
		System.out.println(java.util.Arrays.binarySearch(is, 8));
	}
